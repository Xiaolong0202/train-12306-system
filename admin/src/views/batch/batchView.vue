<template>
    <div class="job">
        <p>
            <a-button type="primary" @click="handleAdd()" style="float: left">
                新增
            </a-button>&nbsp;
            <a-button type="primary" @click="handleQuery()" style="float: left;margin-left: 15px">
                刷新
            </a-button>
        </p>
...
const handleEdit = (record) => {
    modalVisible.value = true;
    Object.assign(job.value,record)
};
