create database business_sharding;
use business_sharding;


drop table if exists `station_0`;
create table `station_0`
(
...
drop table if exists `train_0`;
create table `train_0`
(
...
DROP TABLE IF EXISTS `train_station_0`;
CREATE TABLE `train_station_0`
(
    `id`           bigint        NOT NULL COMMENT 'id',
...
DROP TABLE IF EXISTS `train_carriage_0`;
create table `train_carriage_0`
(
    `id`           bigint not null primary key comment 'id',
    `train_id`     bigint NOT NULL COMMENT '车次id',
...
DROP TABLE IF EXISTS `train_seat_0`;
create table `train_seat_0`
(
    `id`                  bigint      not null primary key comment 'id',
    `train_id`            bigint      NOT NULL COMMENT '车次id',
...
drop table if exists `daily_train_0`;
create table `daily_train_0`
(
    `id`           bigint      not null primary key comment 'id',
...
DROP TABLE IF EXISTS `daily_train_station_0`;
CREATE TABLE `daily_train_station_0`
(
    `id`             bigint        NOT NULL COMMENT 'id',
...
DROP TABLE IF EXISTS `daily_train_carriage_0`;
create table `daily_train_carriage_0`
(
    `id`             bigint not null primary key comment 'id',
    `daily_train_id` bigint NOT NULL COMMENT '车次id',
    `train_index`    int    not null comment '火车箱号',
...
DROP TABLE IF EXISTS `daily_train_seat_0`;
create table `daily_train_seat_0`
(
    `id`                  bigint       not null primary key comment 'id',
...
drop table if exists `daily_train_ticket_0`;
create table `daily_train_ticket_0`
(
    `id`             bigint        not null comment 'id',
    `daily_train_id` bigint        NOT NULL COMMENT '每日车次id',
...
drop table if exists `confirm_order_0`;
create table `confirm_order_0`
(
    `id`                    bigint      not null comment 'id',
...
drop table if exists `train_token_0`;
create table `train_token_0`
(
    `id`             bigint      not null comment 'ID',
    `daily_train_id` bigint      NOT NULL COMMENT '每日车次id',
    `start_date`     date        not null COMMENT '发车日期',
...
drop table if exists `station_1`;
create table `station_1`
(
    `id`          bigint      not null comment 'id',
    `name`        varchar(30) not null comment '站名',
    `name_pinyin` varchar(50) not null comment '站名拼音',
...
DROP TABLE IF EXISTS `train_station_1`;
...
DROP TABLE IF EXISTS `train_carriage_1`;
create table `train_carriage_1`
(
    `id`           bigint not null primary key comment 'id',
    `train_id`     bigint NOT NULL COMMENT '车次id',
    `train_index`  int    not null comment '火车箱号',
...
drop table if exists `daily_train_1`;
create table `daily_train_1`
(
    `id`           bigint      not null primary key comment 'id',
    `start_date`   date        not null comment '发车日期',
    `code`         varchar(20) not null comment '车次编号',
...
DROP TABLE IF EXISTS `daily_train_station_1`;
CREATE TABLE `daily_train_station_1`
(
    `id`             bigint        NOT NULL COMMENT 'id',
    `daily_train_id` bigint        NOT NULL COMMENT '车次id',
    `train_index`    int           NOT NULL COMMENT '车站序号',
...
DROP TABLE IF EXISTS `daily_train_carriage_1`;
create table `daily_train_carriage_1`
(
    `id`             bigint not null primary key comment 'id',
    `daily_train_id` bigint NOT NULL COMMENT '车次id',
    `train_index`    int    not null comment '火车箱号',
...
DROP TABLE IF EXISTS `daily_train_seat_1`;
create table `daily_train_seat_1`
(
    `id`                  bigint       not null primary key comment 'id',
    `daily_train_id`      bigint       NOT NULL COMMENT '每日车次id',
    `carriage_id`         bigint       not null comment '火车箱号',
...
drop table if exists `daily_train_ticket_1`;
create table `daily_train_ticket_1`
(
    `id`             bigint        not null comment 'id',
    `daily_train_id` bigint        NOT NULL COMMENT '每日车次id',
    `start_date`     date          NOT NULL COMMENT '出发日期',
...
drop table if exists `confirm_order_1`;
create table `confirm_order_1`
(
    `id`                    bigint      not null comment 'id',
    `member_id`             bigint      not null comment '会员id',
    `date`                  date        not null comment '日期',
...
drop table if exists `train_token_1`;
create table `train_token_1`
(
    `id`             bigint      not null comment 'ID',
    `daily_train_id` bigint      NOT NULL COMMENT '每日车次id',
    `start_date`     date        not null COMMENT '发车日期',
